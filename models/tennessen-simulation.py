...
msprime_samples = [
    msprime.SampleSet(n, ploidy=1, population=p)
...
msprime_afr = ts.allele_frequency_spectrum(
    [range(samples["AFR"])], mode="site", polarised=True,
...
fs *= theta # rescale to match the msprime simulation
