...
\MSMC & A script provided in the MSMC-tools repository (https://github.com/stschiff/msmc-tools) converts MSMC output to the demes format. Instructions are available in the Guide (https://github.com/stschiff/msmc-tools/blob/master/msmc-tutorial/guide.md)
