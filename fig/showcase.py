...
if __name__ == "__main__":
    ...
    ax1 = plt.subplot2grid(grid, (0, 0), colspan=4, rowspan=2)
    ...
    L = 1e7
    r = 2e-8
    # grr.. 1 sample is actually 2 samples
    ...
    fig.text(0.42, 0.42, "D", fontsize=8)
