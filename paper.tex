...
and data, ever more complex models are being constructed.
...
\ggcomment{We don't showcase Demes output from any inference software.}
\end{abstract}
...
becheler2019quetzal,haller2019slim,hernandez_sfs_code_2015}.
...
\ggcomment{TODO: deduplicate this section and Appendix~\ref{sec:appendix-parsers}}
...
\ggcomment{TODO: deduplicate this section and Appendix~\ref{sec:appendix-scope}}
...
hernandez_sfs_code_2015,kelleher2016efficient,haller2017flexible}
...
%\krtcomment{
%    Aaron has done a bit of this non-static stuff in moments.
%    It may be useful to look over there?
%}
