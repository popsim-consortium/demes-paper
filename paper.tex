...
\aprcomment{I want to keep the subsections that follow short and punchy.
Refer readers to the Appendix for details.}
...
Within populations, allele-frequency dynamics are implicitly assumed to
...
interest, such as explicit spatial structure or
...
primary interface for writing and interchangin demographic models
...
\section*{Illustration: simulation using Demes}
...
\begin{figure}[ht!]
    ...
    \caption{
        ...
        \aprcomment{Extended snippet and Tennessen YAML in the Appendix.}
    }
    \label{fig:showcase}
\end{figure}
