...
\aprcomment{Note: Need to standardize use of ``demes'' vs ``Demes'' vs \Demes.}
...
sequence length or annotations or genomic features.
Genome ploidy is left ambiguous, and selection and dominance models are absent. 
