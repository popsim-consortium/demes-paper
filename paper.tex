...
do not have to sum to one. See \citet{hartfield2016facsexcoal} for more details of the 
mathematical properties of these rates in a coalescent context. \mhcomment{If requested 
I can quickly draw up a schematic diagram to illustrate these partitions.} Note that even if 
$S$, $\sigma$ are set to zero then some residual selfing can occur due to sampling in 
