...
\jkcomment{sketch of last paragraph}
Another basic requirement for scientific progress in the inference
of demographic models is that we should be able to compare the output
of one method to the output of another, or to compare an inferred
demography to some simulated ground truth. Demes facilitates this,
paving the way for things like methods competitions. PopSim
Consortium FTW!
