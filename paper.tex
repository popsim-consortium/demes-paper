...
Detailed descriptions of the population genetic model, parsers, scope, and
...
\subsection*{Parsers}
and languages. 1 paragraph

\subsection*{The scope of Demes}

\begin{itemize}
    \item Static, instead of parameterized models (1 paragraph)
    \item Population level instead of genomic features (1 paragraph)
\end{itemize}
